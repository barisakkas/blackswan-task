...
public class UserController {
    ...
    public ResponseEntity<User> updateUser(
        ...
        user.setFirst_name(userDetails.getFirst_name() == null ? user.getFirst_name() : userDetails.getFirst_name());
        user.setLast_name(userDetails.getLast_name() == null ? user.getLast_name() : userDetails.getLast_name());
