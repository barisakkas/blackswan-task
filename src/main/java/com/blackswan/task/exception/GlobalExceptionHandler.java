...
package com.blackswan.task.exception;
...
public class GlobalExceptionHandler {
  ...
  /**
   * Method argument not valid excpetion handler response entity.
   *
   * @param ex the ex
   * @param request the request
   * @return the response entity
  ...
  public ResponseEntity<?> globalException(Exception ex, WebRequest request) {
    ErrorResponse errorDetails =
        new ErrorResponse(new Date(), HttpStatus.BAD_REQUEST.toString() ,"Request not valid", request.getDescription(false));
